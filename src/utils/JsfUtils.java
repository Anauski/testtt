...
public final class JsfUtils
{
	 ...
	 */
	public static void sendMessage(FacesMessage.Severity severity, String stringFormat, Object... objects)
	{
		keepMessages();
	 ...
	 *            objets à insérer dans la chaine de formatage.
	 */
	public static void sendMessage(String composantId, FacesMessage.Severity severity, String stringFormat, Object... objects)
	{
		keepMessages();
		String message = String.format(stringFormat, objects);
